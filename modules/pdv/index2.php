...
<body>
    <div class="pdv-container">
        ...
        <div class="right-panel">
            ...
            <!-- ===== NOVA SEÇÃO DE FORMAS DE PAGAMENTO ===== -->
            <div class="form-group">
                <label>Forma de Pagamento:</label>
                <div class="payment-form" id="paymentForm">
                    
                    <!-- Modo Simples (Padrão) -->
                    <div id="simplePaymentMode" class="payment-input-row">
                        ...
                        <button type="button" id="addAnotherPaymentBtn" class="add-payment-btn">
                            <i class="fas fa-plus"></i> Adicionar outra forma
                        </button>
                    </div>

                    <!-- Modo Múltiplo (Aparece depois) -->
                    <div id="multiplePaymentMode" class="payment-input-row" style="display: none;">
                        <select id="newPaymentMethodSelect" class="payment-method-select">
                            <option value="dinheiro">Dinheiro</option>
                            <option value="cartao_debito">Cartão de Débito</option>
                            <option value="cartao_credito">Cartão de Crédito</option>
                            <option value="pix">PIX</option>
                        ...
                        <button type="button" id="addPaymentBtn" class="add-payment-btn">
    ...
    <script>
        ...
        function setupEventListeners() {
            ...
            // ===== NOVOS EVENT LISTENERS PARA PAGAMENTOS =====
            ...
            document.getElementById('newPaymentMethodSelect').addEventListener('change', autoFillAmount);
            
            // Atualizar display quando digitar valor
            document.getElementById('paymentAmountInput').addEventListener('input', updatePaymentDisplay);
        ...
        function switchToMultipleMode() {
            // Pegar a forma selecionada no modo simples
            ...
            document.getElementById('multiplePaymentMode').style.display = 'flex';
            ...
            // Focar no novo campo
            document.getElementById('newPaymentMethodSelect').focus();
            
            showAlert(`${getPaymentMethodName(selectedMethod)} adicionado! Agora adicione outras formas.`, 'success');
        }

        function switchToSimpleMode() {
            // Voltar ao modo simples
            document.getElementById('simplePaymentMode').style.display = 'flex';
        ...
        function addPayment() {
            const methodSelect = document.getElementById('newPaymentMethodSelect');
            const amountInput = document.getElementById('paymentAmountInput');
            ...
            // Se ainda há valor restante, focar no próximo
        ...
        function resetSale() {
            ...
            document.getElementById('paymentMethodSelect').value = 'dinheiro';
        ...
        console.log('💰 Melhorias: Campo+Valor, Auto-complete, Lista visual, Validações inteligentes');
    </script>
</body>
</html>